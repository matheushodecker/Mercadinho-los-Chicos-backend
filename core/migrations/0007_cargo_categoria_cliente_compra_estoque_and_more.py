# Generated by Django 5.1.7 on 2025-06-16 17:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_interno', models.CharField(blank=True, help_text='Código interno do produto.', max_length=50)),
                ...
                ('margem_lucro_percentual', models.DecimalField(blank=True, decimal_places=2, help_text='Margem de lucro em %.', max_digits=5, null=True)),
                ...
                ('unidade_medida', models.CharField(default='UN', help_text='Unidade de medida (UN, KG, L, etc).', max_length=10)),
                ('peso', models.DecimalField(blank=True, decimal_places=3, help_text='Peso do produto em KG.', max_digits=8, null=True)),
                ('marca', models.CharField(blank=True, help_text='Marca do produto.', max_length=100)),
