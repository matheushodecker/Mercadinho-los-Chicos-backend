...
class FormaPagamento(models.Model):
    """
    Modelo para armazenar as formas de pagamento.
    """
...
class Pagamento(models.Model):
    """
    Modelo para armazenar os pagamentos das vendas.
    """
    STATUS_CHOICES = [
        ('P', 'Pendente'),
        ('R', 'Recebido'),
    ...
    def __str__(self):
        return f"Pagamento {self.venda.numero_venda} - {self.forma_pagamento.nome}"
